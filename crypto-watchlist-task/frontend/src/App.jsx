...
const App = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const res = await fetch('http://https://crypto-watchlist-task.onrender.com/api/auth/register', {
        method: 'POST',
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch('http://https://crypto-watchlist-task.onrender.com/api/auth/login', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
